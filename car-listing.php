...
*/?>
<p><span><?php /* /*
(' echo htmlentities($cnt);*/?> Listings</span></p>  <!-- Pagination                                                     -->
                <!-- ============================================================== -->  
...
<?php   $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.brand_id as bid  from tblvehicles join tblbrands on tblbrands.brand_id=tblvehicles.brand_id ";
...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><img src="admin/img/vehicleimages/<?php  echo htmlentities($result['Vimage1']);?>" class="img-responsive" alt="Image" style="width: 300px; height: 170px;" /> </a> 
          </div>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php  $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.brand_id as bid  from tblvehicles join tblbrands on tblbrands.brand_id=tblvehicles.brand_id order by id desc limit 4";
$results = $con->query($sql);
$cnt=1;
if ($results->num_rows > 0) {
foreach($results as $result)
