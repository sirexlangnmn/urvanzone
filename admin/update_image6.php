<?php
   ...
   if (isset($_POST['submit']))
   {
      ...
      mysqli_query($con, "UPDATE tblvehicles SET Vimage6 = '$imgName6' WHERE id = '$id' ")or die(mysqli_error()); ?>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <form class="m-t-40" method="POST" novalidate enctype="multipart/form-data">
                           ...
                           <img src="img/vehicleimages/<?php echo $row['Vimage6']; ?>" width="490" height="300" >
                           <br />
                           <br />
