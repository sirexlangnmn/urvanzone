...
<?php }} ?>
      ...
      <aside class="col-md-3">
         ...
         <input type="text" name="daterange" id="datemoto" value="" />
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="text" class="form-control" id="startdate" name="fromdate" placeholder="From Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" id="enddate" name="todate" placeholder="To Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
